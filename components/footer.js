            ...
            <>
                ...
                <footer className={styles.footer}>
                    ...
                    <div className={styles.githubButtons}>
                        <a className={styles.buttonLink} href="https://github.com/MaayanLab/TargetRanger" target="_blank" rel="noopener noreferrer"><Button variant="contained" color="secondary"><img style={{borderRadius: '5px'}} src={process.env.NEXT_PUBLIC_ENTRYPOINT + "/images/GitHub-Mark.png"} alt="GitHub Logo" width={16} height={16} />&nbsp;View source code</Button></a>
                        <a className={styles.buttonLink} href="https://github.com/MaayanLab/TargetRanger/issues/new" target="_blank" rel="noopener noreferrer"><Button variant="contained" color="secondary"><img style={{borderRadius: '5px'}} src={process.env.NEXT_PUBLIC_ENTRYPOINT + "/images/GitHub-Mark.png"} alt="GitHub Logo" width={16} height={16} />&nbsp;Submit an issue</Button></a>
                    </div>
                </footer>
            </>
